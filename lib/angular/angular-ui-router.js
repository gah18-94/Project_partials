...
(function(global, factory) {
    ...
    var Transition = (function() {
        ...
        Transition.prototype._changedParams = function() {
            ...
            var _a = [tc.to, tc.from].map(function(path) { return path.map(function(x) { return x.paramValues; }); }),
                toValues = _a[0],
                fromValues = _a[1];
    ...
    var UrlMatcher = (function() {
        ...
        UrlMatcher.prototype.exec = function(path, search, hash, options) {
            ...
            var allParams = this.parameters(),
                pathParams = allParams.filter(function(param) { return !param.isSearch(); }),
                searchParams = allParams.filter(function(param) { return param.isSearch(); }),
                nPathSegments = this._cache.path.map(function(urlm) { return urlm._segments.length - 1; }).reduce(function(a, x) { return a + x; }),
                values$$1 = {};
    ...
    var TemplateFactory = (function() {
        function TemplateFactory() {
            ...
            /** @hidden */
            this.$get = ['$http', '$templateCache', '$injector', function($http, $templateCache, $injector$$1) {
